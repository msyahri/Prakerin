...
<section class="content">
  ...
  <div class="row">
    ...
    <form action="<?php echo base_url(). 'administrator/berita/edit_aksi'; ?> " method="post" id="form-satuan" enctype="multipart/form-data">
        <table class="table table-striped ">
      <input type="hidden" name="id" class="form-control" value="<?php echo $s->id;?>">
            <tr>

                <td>Judul</td>
                <td><input type="text" class="form-control" name="nama_berita" required="required" value="<?php echo $s->nama_berita ?>"></td>
            </tr>
