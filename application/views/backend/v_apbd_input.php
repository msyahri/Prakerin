...
<section class="content">
  ...
  <div class="row">
    ...
    <form action="<?php echo base_url(). 'administrator/apbd/tambah_aksi'; ?> " method="post" id="form-satuan" enctype="multipart/form-data">
      ...
      <input type="hidden" name="id" class="form-control" value="">
            ...
            <tr>
                ...
                <td>Tahun</td>
                <td><input type="text" class="form-control" name="tahun" required="required" value=""></td>
            </tr>
            <tr>

                <td>Summary</td>
                <td><input type="text" class="form-control" name="summary" required="required" value=""></td>
            </tr>
      ...
      <tr>
                <td>Keterangan</td>
                <td><textarea type="text" class="form-control" name="keterangan" required="required" value=""></textarea></td>
