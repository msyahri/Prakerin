...
<section class="content">
  ...
  <div class="row">
    ...
    <form action="<?php echo base_url(). 'administrator/peta/edit_aksi'; ?> " method="post" id="form-satuan" enctype="multipart/form-data">
      ...
      <tr>
        ...
        <button class="btn btn-danger" value=""><a href="<?php echo base_url(). 'administrator/peta'; ?>" style="color:white">Batal</a></button></td>
